...
namespace Venz.Services
{
    public class OperationResult
    {
        ...
        public static OperationResult CreateCancelled() => new OperationResult() { IsSuccessful = true };
        ...
        public static OperationResult<TValue> CreateCancelled<TValue>() => new OperationResult<TValue>(default(TValue)) { IsCancelled = true };
    }
